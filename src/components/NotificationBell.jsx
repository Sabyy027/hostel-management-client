    ...
    <div className="relative">
      ...
      {isOpen && (
        <>
          ...
          />
          <div className="fixed top-16 right-4 left-4 sm:absolute sm:right-0 sm:left-auto sm:top-auto w-auto sm:w-96 max-w-sm bg-white border border-slate-200 rounded-xl shadow-xl z-50 overflow-hidden">
